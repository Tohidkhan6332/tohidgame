...
const TohidGame = () => {
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-8 lg:mb-12">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
                Challenge your knowledge with AI-powered tohid questions tailored to your interests
              </p>
            </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-slate-300 text-lg sm:text-xl">AI is crafting your personalized tohid challenge</p>
  ...
  if (gameState === 'results') {
    ...
    const getPerformanceData = () => {
      if (percentage >= 90) return { emoji: '🏆', title: 'Outstanding!', color: 'from-yellow-400 to-orange-500', desc: 'You\'re a tohid master!' };
